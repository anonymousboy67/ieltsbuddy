...
const tests: ListeningTest[] = [
  { id: "test-1", name: "IELTS Book 10 Test 1", sections: 4, questions: 40, locked: false },
  { id: "test-2", name: "IELTS Book 10 Test 2", sections: 4, questions: 40, locked: true },
  { id: "test-3", name: "IELTS Book 10 Test 3", sections: 4, questions: 40, locked: true },
  { id: "test-4", name: "IELTS Book 10 Test 4", sections: 4, questions: 40, locked: true },
  { id: "test-5", name: "IELTS Book 11 Test 1", sections: 4, questions: 40, locked: true },
  { id: "test-6", name: "IELTS Book 11 Test 2", sections: 4, questions: 40, locked: true },
];
      ...
      <div className="mt-4 flex flex-col gap-3">
        {tests.map((test, i) => {
          ...
          return test.locked ? (
            ...
            <Link key={test.id} href={`/dashboard/listening/${test.id}`} className={className}>{content}</Link>
          );
        })}
      </div>
    </section>
