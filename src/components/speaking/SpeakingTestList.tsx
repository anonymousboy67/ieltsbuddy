...
const tests: SpeakingTest[] = [
  { name: "IELTS Book 10 Test 1", parts: 3, completed: 0, locked: false },
  { name: "IELTS Book 10 Test 2", parts: 3, completed: 0, locked: true },
  { name: "IELTS Book 10 Test 3", parts: 3, completed: 0, locked: true },
  { name: "IELTS Book 10 Test 4", parts: 3, completed: 0, locked: true },
];
